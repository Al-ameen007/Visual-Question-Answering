...
from vqa.engine import train_model


def parse_args():
    parser = argparse.ArgumentParser(
        description="Train BLIP-VQA model on VizWiz dataset"
    )
    ...
    parser.add_argument(
        "--eval_freq", type=int, default=100, help="Evaluate every N steps"
    )
    parser.add_argument(
        "--eval_iter",
        type=int,
    ...
    parser.add_argument(
        "--plot_training", action="store_true", help="Plot and save training curve"
    )
